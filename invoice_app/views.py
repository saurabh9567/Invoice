...
#         canvas.drawString(border_padding + 10, letter[1] - border_padding - 20, "GST No.: 12345RTY")
        
#         # Mobile number at top right corner
#         canvas.drawRightString(letter[0] - border_padding - 10, letter[1] - border_padding - 20, "Mobile Number: 0987654321")
        
#         # Title in the center
#         canvas.setFont('Helvetica-Bold', 16)
#         canvas.drawCentredString(letter[0] / 2, letter[1] - border_padding - 30, f"Invoice #{invoice.id}")
        
#         # Address in the center
#         canvas.setFont('Helvetica', 12)
#         canvas.drawCentredString(letter[0] / 2, letter[1] - border_padding - 50, "Your Company Address, Street, City, ZIP Code")
...
#         canvas.drawString(border_padding + 10, footer_y + 5, "Account Name: Your Company Name")
#         canvas.drawString(border_padding + 10, footer_y + 20, "Account Number: 1234567890")
#         canvas.drawString(border_padding + 10, footer_y + 35, "IFSC Code: ABCD0123456")  # Adjusted position for more space
#         canvas.restoreState()
...
def generate_invoice_pdf(request, invoice_id):
    ...
    def header_footer(canvas, doc):
        ...
        canvas.drawString(border_padding + 10, footer_y + 20, "Account Number: 1234567890")
        canvas.drawString(border_padding + 10, footer_y + 35, "IFSC Code: ABCD0123456")  # Adjusted position for more space
        canvas.drawRightString(letter[0] - border_padding - 10, footer_y + 35, "Name: Mr. Sonu Pathak")
        canvas.restoreState()
